...
export const TodosInput = ({ onSubmit, ...props }) => {
  ...
  return (
    <div className='w-full h-[100px] bg-[#ECF7FF] flex justify-center items-center sm:p-0 fixed sm:static bottom-0 left-0 right-0 z-50 '>
      <form onSubmit={handleSubmit} className=' px-2 py-2  w-full '>
